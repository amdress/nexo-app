...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  // Inicializamos com um valor seguro (dark/gold); a preferência real do
  // usuário é aplicada assim que o AsyncStorage resolver, sem bloquear o render.
  ...
  // Determinação limpa do modo binário ativo
