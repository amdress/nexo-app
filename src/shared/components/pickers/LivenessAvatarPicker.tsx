...
export default function StaffSignatureCaptureModal({
  ...
  // Reseta o fluxo toda vez que o modal abre para um novo staff
  useEffect(() => {
    if (visible) {
  ...
  // Countdown de 3 segundos antes de disparar a captura
  useEffect(() => {
...
// Estilo mínimo do canvas HTML interno do signature-canvas (roda dentro do WebView)
const signatureWebStyle = `
  .m-signature-pad--footer { display: flex; justify-content: space-between; padding: 12px 20px; }
